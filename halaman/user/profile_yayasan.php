...
<div class="main">
    ...
    <div>
        ...
        <label>
            <p>Yayasan Amal Islami Al Mumtaaz adalah organisasi formal yang bergerak di bidang Keagamaan, Pendidikan,
                Ekonomi, Kesehatan dan Sosial yang mengedepankan ukhuwah Islamiyah. Yayasan Amal Islami Al Mumtaaz
                berdiri pada tanggal 9 Februari 2002. Untuk memberikan kontribusi dalam kemajuan umat Islam khususnya
                pendidikan generasi Islam di kota Karawang menuju masa depan Islam yang lebih gemilang yakni masyarakat
                madani yang dicita-citakan pada tahun 2012 Yayasan Islami Al Mumtaaz mendirikan Sekolah Dasar Islam Al
            ...
            <p>Yayasan Amal Islami Al Mumtaaz merupakan sekolah Islam inklusif yang mengupayakan pembangunan ilmu,
                akhlaq, dan fisik secara seimbang untuk mengantarkan seluruh warga sekolah menjadi pribadi yang bahagia
    ...
    <div>
        <dl>
            ...
            <dd>Menjadi Yayasan Islam yang istiqomah bekerja dengan semangat keikhlasan berlandaskan nilai-nilai Al
                Qur’an dan sunnah Rosul, untuk mewujudkan kepemimpinan Islam sebagai rahmatan lil ‘alamin di Karawang.
            </dd>

            <br>
            <dt><b>II. MISI</b></dt>
            <ul type='number'>
                <li>Menjadikan Al Qur’an dan sunnah Rosul, sebagai inspirasi utama untuk mewujudkan kepemimpinan Islam
                    sebagai rahmatan lil’alamin di seluruh aspek dan bidang kehidupan.</li>
                <li>Menjadikan Dakwah Pendidikan sebagai sarana utama menuju perbaikan umat Islam di Karawang, melalui
                ...
                <li>Melaksanakan kegiatan Ekonomi yang dapat mengokohkan kelembagaan yayasan dan menopang program kerja
                    Yayasan.</li>
            </ul>
            ...
            <ul type='number'>
                <li>Logo Yayasan Al Mumtaaz adalah lima bangun segi enam (hexagonal, atau bentuk sarang lebah) yang
                    ...
                    kesuksesan dakwah.
                    Lebah sendiri adalah makhluk kecil yang dijadikan sebagai perumpamaan bagi umat Islam, karena adanya
...
?>
            ...
            <ul>
                <li> Ketua Harian/ Direktur Operasional
                    ...
                    <dd>- Mengkoordinasikan pelaksanaan program kerja Yayasan baik perencanaan, pelaksanaan, evaluasi,
                ...
                <li>Bendahara
                    ...
                    <dd>- Membuat laporan keuangan secara periodik dan secara tertulis yang disampaikan secara berkala.
                    </dd>
                    <dd>- Menyusun dan mengatur anggaran dengan mengkoordinasikan kepada Ketua Umum.</dd>
                    <dd>- Mengatur pencatatan, penerimaan, penyimpanan, dan pengeluaran keuangan, surat-surat berharga,
                        bukti kas yang berhubungan dengan kegiatan Yayasan dan dlaporkan secara transparan.</dd>
                    <dd>- Mempunyai hak bertanya dan menyelenggarakan audit keuangan pada setiap kepanitiaan kegiatan.
                    </dd>
                    <dd>- Bertanggung jawab kepada Ketua Umum.</dd>
