...
<div class="container">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" id="judul" name="judul" value="<?= $fetch->judul?>" placeholder="Masukan judul"
                    required>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-75">
                <select id="modul" name="modul" required>
                    ...
                    <option value="modul inklusif" <?php if($fetch->modul == 'modul inklusif') echo "selected";?>>Modul
                        Inklusif</option>
                    <option value="modul khusus" <?php if( $fetch->modul=='modul khusus') echo "selected";?>>Modul
                        Khusus</option>
                    <option value="modul stimulus" <?php if( $fetch->modul=='modul stimulus') echo "selected";?>>Modul
                        Stimulus</option>
                </select>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-75">
                <textarea id="ket" name="ket" placeholder="Write something.." style="height:200px"
