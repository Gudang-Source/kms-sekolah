...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Okt 2019 pada 10.48
...
(1, 'file-1571126582.png', 'yayasan'),
(2, 'file-1571128289.jpg', 'pra sekolah'),
...
--
ALTER TABLE `komentar`
  MODIFY `kd_komentar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
